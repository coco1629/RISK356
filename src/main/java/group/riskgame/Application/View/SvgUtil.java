...
//                        System.out.println("select");
    ...
    public void initNeighbour(){
        int i = 0;
        Map<String, String> countriesMap = readProperties("/group.riskgame.Application/map/territorycards.properties");
        Map<String, String> neigh = readProperties("/group.riskgame.Application/map/neighbourhood.properties");
